...
- Verifique se o bug já não foi reportado nas [Issues](https://github.com/rafaelakio/AIPulse/issues)
- Se não encontrar, [crie uma nova issue](https://github.com/rafaelakio/AIPulse/issues/new?template=bug_report.md)
...
- Verifique se a sugestão já não existe nas [Issues](https://github.com/rafaelakio/AIPulse/issues)
- [Crie uma nova issue](https://github.com/rafaelakio/AIPulse/issues/new?template=feature_request.md)
...
```bash
# Clone o repositório
git clone https://github.com/rafaelakio/AIPulse.git
cd AIPulse
...
- Abra uma [Discussion](https://github.com/rafaelakio/AIPulse/discussions)
- Entre em contato via [Issues](https://github.com/rafaelakio/AIPulse/issues)
